...
const AgendaSection = () => {
  ...
  return (
    <section id="agenda" className="section-padding relative" ref={ref}>
      <div className="max-w-5xl mx-auto">
        ...
        <motion.div
          ...
          className="neon-card gradient-top-bar p-10 sm:p-16 text-center relative overflow-hidden"
        >
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <motion.div
              ...
              style={{ border: '1px solid hsla(340, 90%, 55%, 0.15)' }}
            />
            <motion.div
              animate={{ rotate: [360, 0] }}
              transition={{ duration: 25, repeat: Infinity, ease: "linear" }}
              className="absolute -bottom-16 -left-16 w-32 h-32 rounded-full"
              style={{ border: '1px solid hsla(42, 100%, 52%, 0.15)' }}
            />
          </div>
          ...
          <div className="relative z-10">
            <motion.div
              ...
              style={{ boxShadow: '0 0 30px hsla(340, 90%, 55%, 0.4), 0 0 60px hsla(25, 100%, 55%, 0.2)' }}
            >
              <Lock className="w-10 h-10 text-primary-foreground" />
            </motion.div>

            <h3 className="text-2xl sm:text-3xl font-heading font-bold text-foreground mb-4 neon-glow-text-subtle">
            ...
            <div className="inline-flex items-center gap-2 rounded-full px-6 py-3 neon-border">
